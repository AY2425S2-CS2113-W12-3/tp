...
public class UpdateExpenseCommand implements Command {
    ...
    public void execute(ExpenseList expenseList, Ui ui, Storage storage, Categories categories)
        ...
        try {
            ...
            String description = updatedExpense.getDescription() != null ? updatedExpense.getDescription() : "No description";
            String category = updatedExpense.getCategory() != null ? updatedExpense.getCategory() : "Uncategorized";
            String dateStr = updatedExpense.getDate() != null ? DATE_TIME_FORMAT.format(updatedExpense.getDate()) : "No date";
